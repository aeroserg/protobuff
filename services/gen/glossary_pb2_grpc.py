...
class MindmapServiceStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.GetGraph = channel.unary_unary(
                '/glossary.MindmapService/GetGraph',
                request_serializer=glossary__pb2.GetGraphRequest.SerializeToString,
                response_deserializer=glossary__pb2.GraphResponse.FromString,
                _registered_method=True)


class MindmapServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_MindmapServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetGraph': grpc.unary_unary_rpc_method_handler(
                    servicer.GetGraph,
                    request_deserializer=glossary__pb2.GetGraphRequest.FromString,
                    response_serializer=glossary__pb2.GraphResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'glossary.MindmapService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('glossary.MindmapService', rpc_method_handlers)
...
class MindmapService(object):
    ...
    def GetGraph(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            glossary__pb2.GraphResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
